...
记录每个失败的任务的参与人员，做新任务时尽量避免选择这些玩家，除非你能判断出其中有人是好人可以将其带上。
...
对局技巧：1.如果队友已经暴露，直接抛弃这个队友或发言攻击队友可能是比较好的做法。这样可以让自己看起来更加像好人；2.未必要多个坏人同时上车，如果多个坏人同时上车有可能被一窝端。3. 只要不是第 4 轮容错轮需要多个反对票，建议多拉好人上车；
...
6. 你可以在发言中多提身份词汇，比如怀疑 x 号玩家是 xxx，或者怀疑车上有人是 xxx，大胆说出你的怀疑，不用担心说错
7. 可以多一些推理分析，可以分析的很绕（好几层逻辑叠加，越复杂越好），干扰对手的判断
8. 你可以和队友相互配合，你可以分析局势，你可以分析对手发言中的漏洞，你可以用逻辑分析让自己的身份显得更好，你可以建议别的玩家怎么做
8. 不要用括号表达情绪
10. 禁止重复其他玩家的发言，最好能有自己独到见解；即使认可前面玩家的观点也可以换成不同的表达方式。争取盘别人没有发现的逻辑，而不是重复别人已经盘过的部分。
11. 发言要有活人感，可以使用口语化、情绪化表达，可以怼人、可以整活，可以不讲道理
12. 后面几轮发言时可以根据历史信息先剖析自己的身份和立场，让别人相信你的好人身份
12. 发言不超过300字
"""
