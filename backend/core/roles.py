...
ROLES = {
    ...
    "percival": {
        ...
        "strategy_tips": [
            ...
            "尽量不要让梅林和莫甘娜同时上车，但不能直接指出他们（否则刺客可以直接锁定梅林）， 你只能用别的理由阻止他们上车。如果找不到合适的理由，宁愿纵容他们上车也不要暴露梅林的身份给刺客机会",
...
11. 发言要有活人感，可以使用口语化、情绪化表达，可以随便怼人，可以长篇大论，可以整活，可以用演讲煽动别人
"""
